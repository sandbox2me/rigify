...
from .arm import generate as generate_arm
from .leg import create_leg
from .leg import generate as generate_leg
from .paw import create_paw
from .paw import generate as generate_paw
...
from ..widgets import create_gear_widget
...
class Rig:
    ...
    def generate(self):
        ...
        if self.limb_type == 'arm':
            return generate_arm(self)
        elif self.limb_type == 'leg':
            return generate_leg(self)
        elif self.limb_type == 'paw':
            return generate_paw(self)
